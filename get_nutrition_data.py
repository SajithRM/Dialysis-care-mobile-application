...
def get_nutrition(food_name):
    nutrition_data = pd.DataFrame(columns=['name', 'protein', 'calcium', 'fat', 'carbohydrates', 'vitamins',Sodium,Potassium,Kidney-Friendly])
    for name in food_name:
        ...
        for item in first_food_nutrition_list:
            ...
            if item['nutrientNumber'] == "307":
                sodium = item['value']
            if item['nutrientNumber'] == "306":
                potassium = item['value']
            if item['nutrientNumber'] == "1004":
                kidney_friendly = item['value']
                continue
